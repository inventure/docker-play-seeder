...
- Interactive using custom values
  ...
  Base Docker Image [debian:bullseye-20240722-slim] : debian:bullseye-20240722-slim
  ...
  [info] - base-image => debian:bullseye-20240722-slim
  [info] - play       => 2.9.5
  [info] - scala      => 2.13.14
...
- Non interactive using custom values
  ```shell 
  sbt "dockerSeed base-image debian:bullseye-20240722-slim play-version 2.9.5 scala-version 2.13.14 java-version 11.0.24-amzn play-slick-version 5.3.1 sbt-version 1.10.1 docker-registry funkychicken" 
  ```
...
- Run the following command to combine the manifest
  ...
  Example:
  ```shell
  docker manifest create talaengineering/play-dependencies-seed:play-2.9.5-sbt-1.10.1-scala-2.13.14-play-slick-5.3.1-java-11.0.24-amzn-debian-bullseye-20240722-slim-multiarch
    --amend alice/play-dependencies-seed:play-2.9.5-sbt-1.10.1-scala-2.13.14-play-slick-5.3.1-java-11.0.24-amzn-debian-bullseye-20240722-slim-arm64
    --amend sally/play-dependencies-seed:play-2.9.5-sbt-1.10.1-scala-2.13.14-play-slick-5.3.1-java-11.0.24-amzn-debian-bullseye-20240722-slim-amd64
  ```
