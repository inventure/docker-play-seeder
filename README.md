...
- Non interactive using custom values
  ```shell 
  sbt "dockerSeed base-image debian:bullseye-20241016-slim play-version 2.9.5 scala-version 2.13.15 java-version 11.0.25-amzn play-slick-version 5.3.1 sbt-version 1.10.4 docker-registry funkychicken" 
  ```
  
 - Non interactive with some custom values and some default values
   ```shell 
   sbt "dockerSeed with-defaults sbt-version 1.10.4 docker-registry monkeybusiness"
   ``` 
...
- Run the following command to combine the manifest
  ...
  Example:
  ```shell
  docker manifest create talaengineering/play-dependencies-seed:play-2.9.5-sbt-1.10.4-scala-2.13.15-play-slick-5.3.1-java-11.0.25-amzn-debian-bullseye-20241016-slim-multiarch
    --amend alice/play-dependencies-seed:play-2.9.5-sbt-1.10.4-scala-2.13.15-play-slick-5.3.1-java-11.0.25-amzn-debian-bullseye-20241016-slim-arm64
    --amend sally/play-dependencies-seed:play-2.9.5-sbt-1.10.4-scala-2.13.15-play-slick-5.3.1-java-11.0.25-amzn-debian-bullseye-20241016-slim-amd64
  ```
- Check the combined manifest
  ``shell
  docker manifest inspect talaengineering/play-dependencies-seed:play-2.9.4-sbt-1.10.4-scala-2.13.15-play-slick-5.3.1-java-11.0.23-amzn-debian-bullseye-20240701-slim-multiarch
  ``
- Push the combined manifest
  ``shell
  docker manifest push talaengineering/play-dependencies-seed:play-2.9.4-sbt-1.10.4-scala-2.13.15-play-slick-5.3.1-java-11.0.23-amzn-debian-bullseye-20240701-slim-multiarch
  ``
